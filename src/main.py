...
class MainUI(QMainWindow):
    ...
    def add_page_content_1(self, page):
        ...
        self.solo_method_radio_button_2 = QRadioButton("古战场")
    ...
    def add_page_content_2(self, page):
        ...
        layout.addRow(self.multi_hp_upper_label, self.multi_hp_upper_spinbox)
